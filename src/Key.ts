 ...
 *
 * @see MDN https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/key/Key_Values#Speech_recognition_keys
 * @see ts-key-enum https://www.npmjs.com/package/ts-key-enum
 *
 */
